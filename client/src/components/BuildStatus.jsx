...
const icons = {
  'SUCCESSFUL': <img src={buildSuccessfulIcon} className={styles.icon} alt="Build success"/>,
  'FAILED': <img src={buildFailedIcon} className={styles.icon} alt="Build failed"/>,
  'IN_PROGRESS': <img src={buildInProgressIcon} className={styles.icon} alt="Build is in progress"/>,
};
